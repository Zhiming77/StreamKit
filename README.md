# StreamKit: A streamer command center built from scratch to learn TypeScript, React, and full-stack development.
...
- [x] Step 0 — Project setup (Vite + React + TypeScript + Tailwind)
...
- [ ] Step 9 — Analytics Dashboard (Recharts)
